...
Note that two of the workloads, independent_writes and dense, are reused from supplied workloads from class homework assignments. Then, run the simulation code as written below
